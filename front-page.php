        ...
        <div class="row">
          ...
          <ul class="list-inline text-right">
            <li><a href="https://de-de.facebook.com/" target="_blank">
              <img src="<?php echo get_bloginfo('template_directory')?>/img\online_social_media_facebook-128.png" alt="Facebook-Link" width="40px"></a></li>
            <li><a href="https://twitter.com/?lang=de" target="_blank">
              <img src="<?php echo get_bloginfo('template_directory')?>/img\1481745744_twitter_online_social_media.png" alt="Twitter-Link" width="40px"></a></li>
            <li><a href="https://www.xing.com/" target="_blank">
              <img src="<?php echo get_bloginfo('template_directory')?>/img\social_media_logo_xing-128.png" alt="Xing-Link" width="40px"></a></li>
            <li><a href="https://de.linkedin.com/" target="_blank">
              <img src="<?php echo get_bloginfo('template_directory')?>/img\online_social_media_linked_in-128.png" alt="Likedin-Link" width="40px"></a></li>
          </ul>
          </div>
        </div>
      </header>
