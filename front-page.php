    ...
    <div class="home-content">
      <header class="row header">
          <div class="col-sm-2">
            ...
            ?>
            <a href="front-page.php" target="_top"><img class="img-responsive" src="<?php echo $logoUrl; ?>" alt="Logo - <?php echo get_bloginfo('name'); ?>">
          </div>
          <div class="col-sm-10">
            <ul class="list-inline pull-right social-list">
              <li><a href="https://www.facebook.com/OHM-Professional-School-330373620679840/?fref=ts" target="_blank"><img src="<?php echo get_bloginfo('template_directory');?>/img/facebook.svg" alt="" /></a></li>
