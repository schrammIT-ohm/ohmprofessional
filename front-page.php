  ...
  <div class="fullscreen-wrapper">
    <div class="home-content">
      ...
      <header>
        <div class="row">
          ...
          <div class="col-sm-10">
            ...
            <ul class="list-inline reiter">
                <li> <a href="404.php" target="blank" alt=InformationenzumStudiumprogramm>Informationen zum Studium</a></li>
                <li> <a href="404.php" target="blank" alt=Termine>Kalender</a></li>
      ...
      <ul class="navbar-fixed-bottom pull-left list-inline">
        ...
        <li><a href="404.php" target="blank" alt="AGB">Datenschutz</a></li>
